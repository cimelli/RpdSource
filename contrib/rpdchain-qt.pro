...
RESOURCES += src/qt/rpdchain.qrc src/qt/rpdchain_locale.qrc

TRANSLATIONS += src/qt/locale/rpdchain_bg.ts \
                src/qt/locale/rpdchain_de.ts \
                src/qt/locale/rpdchain_en.ts \
                src/qt/locale/rpdchain_es.ts \
                src/qt/locale/rpdchain_fi.ts \
                src/qt/locale/rpdchain_fr.ts \
                src/qt/locale/rpdchain_it.ts \
                src/qt/locale/rpdchain_ja.ts \
                src/qt/locale/rpdchain_pl.ts \
                src/qt/locale/rpdchain_pt.ts \
                src/qt/locale/rpdchain_ru.ts \
                src/qt/locale/rpdchain_sk.ts \
                src/qt/locale/rpdchain_sv.ts \
                src/qt/locale/rpdchain_vi.ts \
                src/qt/locale/rpdchain_zh_CN.ts \
                src/qt/locale/rpdchain_zh_TW.ts
