...
Automatic zPIV backup has been disabled. Thus, the following configuration options have been removed  (either as entries in the rpdchain.conf file or as startup flags):
- `autozpivbackup`
- `backupzpiv`
- `zpivbackuppath`
