...
#ifndef RPDCHAIN_ZRPDTRACKER_H
#define RPDCHAIN_ZRPDTRACKER_H
...
public:
    CzRPDTracker(CWallet* parent);
    ~CzRPDTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzRPDWallet* zRPDWallet = NULL);
