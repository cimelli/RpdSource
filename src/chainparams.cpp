...
void GenesisGeneratorV2(CBlock genesis)
{
    ...
    uint32_t nGenesisTime = 1694531982; // Tue Jun 20 2023 22:22:07 GMT-0400 (Eastern Daylight Time)
...
public:
    CMainParams()
    {
        ...
        //genesis = CreateGenesisBlock(1694531982, 2402015, 0x1e0ffff0, 1, 250 * COIN);
        //consensus.hashGenesisBlock = genesis.GetHash();
