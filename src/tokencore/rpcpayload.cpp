...
static UniValue createtokenpayloadfreeze(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 3)
        throw runtime_error(
            ...
            "\nExamples:\n"
            + HelpExampleCli("createtokenpayloadfreeze", "\"RHTHRxu3aSDV4deakjC7VmsiUp7c6dfbvs\" 1 \"100\"")
            + HelpExampleRpc("createtokenpayloadfreeze", "\"RHTHRxu3aSDV4deakjC7VmsiUp7c6dfbvs\", 1, \"100\"")
        );
...
static UniValue createtokenpayloadunfreeze(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 3)
        throw runtime_error(
            ...
            "\nExamples:\n"
            + HelpExampleCli("createtokenpayloadunfreeze", "\"RHTHRxu3aSDV4deakjC7VmsiUp7c6dfbvs\" 1 \"100\"")
            + HelpExampleRpc("createtokenpayloadunfreeze", "\"RHTHRxu3aSDV4deakjC7VmsiUp7c6dfbvs\", 1, \"100\"")
        );
