...
int DEx_payment(const uint256& txid, unsigned int vout, const std::string& addressSeller, const std::string& addressBuyer, int64_t amountPaid, int block, const std::vector < std::pair< std::string, int64_t > >& payments, uint64_t* nAmended = NULL);
