#ifndef TOKENCORE_ERRORS_H
#define TOKENCORE_ERRORS_H
...
enum MPRPCErrorCode
{
    ...
    MP_TX_IS_NOT_TOKEN_PROTOCOL    = -3336,  // No Token Layer Protocol transaction.
};
...
inline std::string error_str(int ec) {
  ...
  switch (ec)
  {
      ...
      case MP_INPUT_NOT_IN_RANGE:
          ec_str = "Input value supplied larger than supported in Token Layer Protocol";
          break;
