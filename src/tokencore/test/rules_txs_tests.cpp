...
BOOST_AUTO_TEST_CASE(simple_send_restrictions)
{
    ...
    BOOST_CHECK(!IsTransactionTypeAllowed(0,                TOKEN_PROPERTY_RPD,  TOKEN_TYPE_SIMPLE_SEND, MP_TX_PKT_V0));
    BOOST_CHECK(!IsTransactionTypeAllowed(TOKEN_SEND_BLOCK,   TOKEN_PROPERTY_RPD,  TOKEN_TYPE_SIMPLE_SEND, MP_TX_PKT_V0));
    BOOST_CHECK(!IsTransactionTypeAllowed(MAX_BLOCK,        TOKEN_PROPERTY_RPD,  TOKEN_TYPE_SIMPLE_SEND, MAX_VERSION));
