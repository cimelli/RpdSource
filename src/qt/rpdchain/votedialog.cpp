...
#include "qt/rpdchain/forms/ui_votedialog.h"

#include "qt/rpdchain/mnmodel.h"
#include "qt/rpdchain/mnselectiondialog.h"
...
{
    proposal = make_unique<ProposalInfo>(prop);
...
{
    RPDCHAINGUI* window = dynamic_cast<RPDCHAINGUI*>(parent());
