...
#include "qt/rpdchain/settings/settingsnetworkwidget.h"
#include "qt/rpdchain/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/rpdchain/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(RPDCHAINGUI* _window, QWidget *parent) :
