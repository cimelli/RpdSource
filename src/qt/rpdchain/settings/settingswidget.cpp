...
#include "qt/rpdchain/settings/forms/ui_settingswidget.h"
...
SettingsWidget::SettingsWidget(RPDCHAINGUI* parent) :
    PWidget(parent),
    ui(new Ui::SettingsWidget)
{
    ...
    connect(ui->pushButtonHelp1, &QPushButton::clicked, window, &RPDCHAINGUI::openFAQ);
