...
#include "qt/rpdchain/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/rpdchain/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(RPDCHAINGUI* _window, QWidget *parent) :
...
void SettingsConsoleWidget::clear(bool clearHistory)
{
    ...
    message(CMD_REPLY, (tr("Welcome to the RPDCHAIN RPC console.") + "<br>" +
