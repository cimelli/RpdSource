...
#include "qt/rpdchain/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/rpdchain/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(RPDCHAINGUI* _window, QWidget *parent) :
