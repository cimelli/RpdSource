...
#include "qt/rpdchain/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(RPDCHAINGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("RPDCHAIN_tx_csv_export(*.csv)") : tr("RPDCHAIN_addresses_csv_export(*.csv)"),
                                        nullptr);
