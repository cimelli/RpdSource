...
#include "qt/rpdchain/createproposaldialog.h"
#include "qt/rpdchain/forms/ui_createproposaldialog.h"

#include "qt/rpdchain/contactsdropdown.h"
#include "qt/rpdchain/governancemodel.h"
...
CreateProposalDialog::CreateProposalDialog(RPDCHAINGUI* parent, GovernanceModel* _govModel, WalletModel* _walletModel) :
    QDialog(parent),
...
void CreateProposalDialog::setupPageOne()
{
    ...
    setEditBoxStyle(ui->labelName, ui->lineEditPropName, "Proposal name");
    setEditBoxStyle(ui->labelURL, ui->lineEditURL, "Include an URL describing your proposal");
...
void CreateProposalDialog::setupPageTwo()
{
    ...
    setEditBoxStyle(ui->labelAmount, ui->lineEditAmount, "0.00 RPD");
    setCssProperty(ui->labelMonths, "text-title");
    setEditBoxStyle(ui->labelAddress, ui->lineEditAddress, "Enter address");
    setCssProperty(ui->lineEditAddress, "edit-primary-multi-book");
    actAddrList = ui->lineEditAddress->addAction(QIcon("://ic-arrow-drop-down"), QLineEdit::TrailingPosition);
...
void CreateProposalDialog::onAddrListClicked()
{
    ...
    if (!menuContacts) {
        ...
        menuContacts = new ContactsDropdown(
                width,
                height,
                dynamic_cast<RPDCHAINGUI*>(parent()),
                this
        );
