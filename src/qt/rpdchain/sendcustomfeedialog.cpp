...
#include "qt/rpdchain/sendcustomfeedialog.h"
#include "qt/rpdchain/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(RPDCHAINGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &RPDCHAINGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
