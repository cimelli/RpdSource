...
#include "qt/rpdchain/forms/ui_governancewidget.h"

#include "qt/rpdchain/createproposaldialog.h"
#include "qt/rpdchain/governancemodel.h"
#include "qt/rpdchain/mnmodel.h"
#include "qt/rpdchain/proposalinfodialog.h"
#include "qt/rpdchain/qtutils.h"
#include "qt/rpdchain/votedialog.h"
        ...
        ui(new Ui::GovernanceWidget)
{
    ...
    initComboBox(ui->comboBoxSort, lineEdit, "btn-combo");
    ...
    initComboBox(ui->comboBoxFilter, lineEditFilter, "btn-filter");
...
void GovernanceWidget::onCreatePropClicked()
{
    ...
    auto ptrUnlockedContext = make_unique<WalletModel::UnlockContext>(walletModel->requestUnlock());
