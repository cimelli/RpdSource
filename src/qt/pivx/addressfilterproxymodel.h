...
#ifndef RPDCHAIN_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define RPDCHAIN_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //RPDCHAIN_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
