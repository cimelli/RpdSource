...
#include "qt/rpdchain/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/rpdchain/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(RPDCHAINGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to RPDCHAINGUI::handleRestart()
