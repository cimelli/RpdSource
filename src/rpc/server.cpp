...
UniValue stop(const JSONRPCRequest& jsonRequest)
{
    ...
    if (jsonRequest.fHelp || jsonRequest.params.size() > 1)
        throw std::runtime_error(
            "stop\n"
            "\nStop RPDCHAIN server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "RPDCHAIN server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* RPDCHAIN features */
        {"rpdchain", "listmasternodes", &listmasternodes, true },
        {"rpdchain", "getmasternodecount", &getmasternodecount, true },
        {"rpdchain", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"rpdchain", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"rpdchain", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"rpdchain", "masternodecurrent", &masternodecurrent, true },
        {"rpdchain", "startmasternode", &startmasternode, true },
        {"rpdchain", "createmasternodekey", &createmasternodekey, true },
        {"rpdchain", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"rpdchain", "listmasternodeconf", &listmasternodeconf, true },
        {"rpdchain", "getmasternodestatus", &getmasternodestatus, true },
        {"rpdchain", "getmasternodewinners", &getmasternodewinners, true },
        {"rpdchain", "getmasternodescores", &getmasternodescores, true },
        {"rpdchain", "preparebudget", &preparebudget, true },
        {"rpdchain", "submitbudget", &submitbudget, true },
        {"rpdchain", "mnbudgetvote", &mnbudgetvote, true },
        {"rpdchain", "getbudgetvotes", &getbudgetvotes, true },
        {"rpdchain", "getnextsuperblock", &getnextsuperblock, true },
        {"rpdchain", "getbudgetprojection", &getbudgetprojection, true },
        {"rpdchain", "getbudgetinfo", &getbudgetinfo, true },
        {"rpdchain", "mnbudgetrawvote", &mnbudgetrawvote, true },
        {"rpdchain", "mnfinalbudget", &mnfinalbudget, true },
        {"rpdchain", "checkbudgets", &checkbudgets, true },
        {"rpdchain", "mnsync", &mnsync, true },
        {"rpdchain", "spork", &spork, true },
        ...
        {"zerocoin", "getzrpdseed", &getzrpdseed, false },
        {"zerocoin", "setzrpdseed", &setzrpdseed, false },
        {"zerocoin", "generatemintlist", &generatemintlist, false },
        {"zerocoin", "searchdzrpd", &searchdzrpd, false },
        {"zerocoin", "dzrpdstate", &dzrpdstate, false },
...
{
    return "> rpdchain-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:1590/\n";
}
