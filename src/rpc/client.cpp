...
static const CRPCConvertParam vRPCConvertParams[] =
    {
        ...
        { "token_getcrowdsale", 0 },
        { "token_getcrowdsale", 1 },
        { "token_getgrants", 0 },
        { "gettokenbalance", 1 },
        { "gettoken", 0 },
        ...
        { "token_sendissuancecrowdsale", 1 },
        { "token_sendissuancecrowdsale", 2 },
        { "token_sendissuancecrowdsale", 3 },
        { "token_sendissuancecrowdsale", 9 },
        { "token_sendissuancecrowdsale", 11 },
        { "token_sendissuancecrowdsale", 12 },
        { "token_sendissuancecrowdsale", 13 },
        { "token_senddexsell", 1 },
        { "token_senddexsell", 4 },
        { "token_senddexsell", 6 },
