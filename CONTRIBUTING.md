Contributing to RPDCHAIN Core
============================

The RPDCHAIN Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/rpdchain-project/rpdchain/blob/master/doc/translation_process.md)
...
The following applies to code changes to the RPDCHAIN Core project, and is not to be
confused with overall RPDCHAIN Network Protocol consensus changes.

Whether a pull request is merged into RPDCHAIN Core rests with the project merge
...
Patches that change RPDCHAIN consensus rules are considerably more involved than
...
Where a patchset proposes to change the RPDCHAIN consensus, it must have been
...
The project leader is the release manager for each RPDCHAIN Core release.
